  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: `radial-gradient(circle at center, #0a0ee6, transparent 70%)`,
        }}
      />
      <div
        className="absolute right-0 bottom-0 h-[300px] w-[300px] rounded-full opacity-10 blur-[100px]"
        style={{
          background: `radial-gradient(circle at center, #3a0ae6, transparent 70%)`,
        }}
      />
          ...
          <div className="grid md:grid-cols-2">
            ...
            >
              <div className="flex flex-col items-center justify-center overflow-hidden">
                <article className="relative mx-auto h-[350px] min-h-60 max-w-[450px] overflow-hidden rounded-3xl border bg-gradient-to-b from-[#0a95e6] to-[#0ae6af]/5 p-6 text-3xl tracking-tight text-white md:h-[450px] md:min-h-80 md:p-8 md:text-4xl md:leading-[1.05] lg:text-5xl">
                  Conectando você às melhores experiências.
                  <div className="absolute -right-20 -bottom-20 z-10 mx-auto flex h-full w-full max-w-[300px] items-center justify-center transition-all duration-700 hover:scale-105 md:-right-28 md:-bottom-28 md:max-w-[550px]">
                    <Earth
                      scale={1.1}
                      baseColor={[1, 1, 1]} // branco puro
                      markerColor={[1, 1, 1]} // marcadores brancos
                      glowColor={[1, 1, 1]} // brilho branco
                    />
                  </div>
                </article>
              </div>
